...
public class Analysis4Driver {

	public static void main(String[] args) throws Exception {

		Path inputPath = new Path("/home/pranay/Downloads/yelp_dataset_challenge_round9/yelp_academic_dataset_checkin.json");
		Path outputDir = new Path("/home/pranay/Downloads/SecondarySortingLab-master/analysis4_1_output");
		Path inputPath1 = new Path("/home/pranay/Downloads/yelp_dataset_challenge_round9/yelp_academic_dataset_business.json");
		Path outputDir1 = new Path("/home/pranay/Downloads/SecondarySortingLab-master/analysis4_2_output");

		// Create configuration
		Configuration conf = new Configuration(true);

		// Create job
		Job job = new Job(conf, "Analysis 5");
